...
public class DataGropedService {
    ...
    public List<Map<String, Object>> groupDataByDisease(List<Map<String, Object>> resultList) {
        ...
        for (Map<String, Object> item : resultList) {
            ...
            if (!diseaseData.containsKey("title")) {
                ...
                diseaseData.put("totalData", new ArrayList<>(Collections.nCopies(8, 0))); // 8개 항목으로 초기화
            ...
            totalData.set(0, goalCount);  // 목표건수 (고정값)
            ...
            subRow.add(String.valueOf(goalCount));  // 고정된 목표건수
    ...
    public List<Map<String, Object>> groupDataByInstitution(List<Map<String, Object>> resultList) {
        ...
        Map<String, Map<String, Object>> groupedData = new HashMap<>();
        Set<String> processedImageIds = new HashSet<>(); // IMAGE_ID 중복 체크
        Map<String, Integer> diseaseGoalCountMap = new HashMap<>(); // 질환별 목표건수 저장
        ...
        for (Map<String, Object> item : resultList) {
            ...
            // 질환별 목표건수 설정 (첫 번째 발견된 질환에 대해서만 목표건수를 설정)
            if (!diseaseGoalCountMap.containsKey(diseaseClass)) {
                int goalCount = (item.get("목표건수") != null) ? (int) item.get("목표건수") : 0;
                diseaseGoalCountMap.put(diseaseClass, goalCount);
            }
            ...
            int goalCount = diseaseGoalCountMap.getOrDefault(diseaseClass, 0);  // 질환별 목표건수 사용
    ...
    public Map<String, Object> createAllData(List<Map<String, Object>> resultList, String groupingKey, String title) {
        ...
        // 항목 수에 맞게 초기화 (8개의 항목으로 수정)
        List<Integer> totalData = new ArrayList<>(Collections.nCopies(8, 0));  // 8개 항목
        ...
        for (Map<String, Object> item : resultList) {
            ...
            String diseaseClass = (String) item.get("DISEASE_CLASS"); // 질환 클래스 가져오기
